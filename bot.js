...
// for reading text         
	...
	const chan= "429182742987669516" ;
        message.429470999692705794.send("Category:  "+ (cat) ); // send that user a DM
	message.429470999692705794.send(" Tip: " + (tip) +" by " + (  message.author.username  ));
